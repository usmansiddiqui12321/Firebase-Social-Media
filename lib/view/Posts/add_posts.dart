...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider(create: (_) => PostController(),
      child: Consumer<PostController>(builder: (context, provider, child) {
        return Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            RoundButton(onpress: () {}, title: "Upload Image Screen")
          ],
        ),
      );
      },),)
